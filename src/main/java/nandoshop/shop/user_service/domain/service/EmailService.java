...
public class EmailService {
    ...
    public void sendPasswordResetEmail(String to, String username, String resetLink) {
        ...
        String body = templateProcessor.renderTemplate(
                ...
                Map.of("username", username, "resetLink", resetLink, "title", "Restablecimiento de Contraseña",
                        "headerTitle", "NandoShop"));
        emailSenderPort.sendEmail(new Email(to, subject, body));
    }
    ...
    public void sendVerifyEmail(String to, String username, String verifyLink) {
        ...
        String body = templateProcessor.renderTemplate(
                ...
                Map.of("username", username, "verifyLink", verifyLink, "title", "Verificación de Correo Electrónico",
                        "headerTitle", "NandoShop"));
        emailSenderPort.sendEmail(new Email(to, subject, body));
    }
}
